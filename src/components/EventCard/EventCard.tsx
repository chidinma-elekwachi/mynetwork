...
const events: Event[] = [
  ...
  },
  {
    ...
    description: 'Amazing football festival featuring top programmers like chichi.',
    imageUrl: 'https://via.placeholder.com/300',
    date: '2024-07-20'
  },
  {
...
const EventCard = () => {
  return (
    <div className="flex flex-wrap space-between">
      {events.map(event => (
        <div key={event.id} className="bg-white rounded-lg overflow-hidden shadow-md w-full sm:w-1/2 lg:w-1/3 p-2 my-2">
          ...
          <div className="p-4">
            ...
            <button className="bg-customGreen text-white py-1 px-4 rounded">Interested</button>
          </div>
        </div>
      ))}
    </div>
